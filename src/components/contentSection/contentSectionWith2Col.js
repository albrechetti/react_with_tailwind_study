function ContentSectionWith2Col() {
    ...
    return (
        <section className="flex w-screen bg-indigo-50  h-screen md:h-96 p-8">
            <div className="container max-w-screen-xl mx-auto grid md:grid-cols-3 content-center md:space-x-8 ">
                ...
                <buton className="rounded-full py-3 px-9 bg-indigo-600 float-left  text-white"> Exemplo Botao</buton>
                </div>
                <div className="box-content mb-8 md:mb-0">
                <h1 className="text-2xl text-indigo-900 text-left mb-4">Lorem ipsum dolor sit amet</h1>
                <p className="text-justify mb-4">
